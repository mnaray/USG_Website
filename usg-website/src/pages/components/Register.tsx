    ...
    return (
        <div className="">
            <form className='flex flex-col items-center'>
                ...
                <input type="password" className='text-neutral-800 m-2 p-2 bg-slate-500 rounded' id="passwordagain" name='passwordagain' placeholder='password wiederholen' required minLength={8} />
